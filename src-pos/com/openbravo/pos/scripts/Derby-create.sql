...
CREATE UNIQUE INDEX CURRENCY_ISO_CODE ON CURRENCY(ISO_CODE);

INSERT INTO CURRENCY (CURRENCY_ID, COSTINGPRECISION, CURSYMBOL, DESCRIPTION, ISACTIVE, ISO_CODE, STDPRECISION) 
VALUES ('1', 4, 'VEF', 'Bolivar Fuerte', 'Y', 'VEF', 2);
INSERT INTO CURRENCY (CURRENCY_ID, COSTINGPRECISION, CURSYMBOL, DESCRIPTION, ISACTIVE, ISO_CODE, STDPRECISION) 
VALUES ('2', 4, '$', 'US Dollar', 'Y', 'USD', 2);
INSERT INTO CURRENCY (CURRENCY_ID, COSTINGPRECISION, CURSYMBOL, DESCRIPTION, ISACTIVE, ISO_CODE, STDPRECISION) 
VALUES ('3', 4, 'E', 'Euro', 'Y', 'EUR', 2);
...
CREATE TABLE CONVERSIONRATE(
    ...
    CHECK (ISACTIVE IN ('Y','N')),
    CONSTRAINT CONVERSIONRATE_CONVERSIONTYPE_fk FOREIGN KEY (CONVERSIONTYPE_ID) REFERENCES CONVERSIONTYPE(CONVERSIONTYPE_ID),
    CONSTRAINT CONVERSIONRATE_CURRENCY_fk FOREIGN KEY (CURRENCY_ID) REFERENCES CURRENCY(CURRENCY_ID),
    CONSTRAINT CONVERSIONRATE_CURRENCYTO_fk FOREIGN KEY (CURRENCYTO_ID) REFERENCES CURRENCY(CURRENCY_ID)
);